...
* **aibom**: `snyk aibom test --severity-threshold` now filters the displayed and JSON results by severity, not only the exit code. ([a429c2e](https://github.com/snyk/snyk/commit/a429c2e3f31aefd0f672d3629e46f71fd03414c5))
