...
describe('TimingSequencer shard balance', () => {
  const savedPlatform = process.env.TEST_SNYK_TIMINGS_PLATFORM;
  // Load real platform weights so balance assertions are meaningful.
  ...
  if (savedPlatform === undefined) {
    ...
    process.env.TEST_SNYK_TIMINGS_PLATFORM = savedPlatform;
  }
