...
========================
  ...
  * [e15f787](https://github.com/flatiron/nconf/commit/e15f787) Updated README and allowed a simply syntax (`Michael Hart`)
...
=========================
  ...
  * [a2464d2](https://github.com/flatiron/nconf/commit/a2464d2) [api] Load sources into the default system store so they are permanently cached (`indexzero`)
