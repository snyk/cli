...
scope for this document, and expected to be specified by implementers.
...
The `openssl` command line tool can be used to generate or verify the signatures listed above.
