  ...
  function runTests(t, error, modules) {
    ...
    keys.forEach(function (key) {
      ...
      if (key === 'demo-private') {
        ...
        t.equal(expectedModules[key], modules.dependencies[key].version, key + ' version is correct');
        t.equal(modules.dependencies[key].valid, true, key + ' version was satisified WRT dep');
      }
