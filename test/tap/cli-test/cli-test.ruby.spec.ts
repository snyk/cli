...
export const RubyTests: AcceptanceTests = {
  language: "Ruby",
  tests: {
    "`test ruby-app-no-lockfile --file=Gemfile`": (
      params,
      utils
    ) => async t => {
    ...
    "`test ruby-app-thresholds --ignore-policy`": (
      params,
      utils
    ) => async t => {
      utils.chdirWorkspaces();
    ...
    "`test ruby-app-policy` with cloud ignores": (params, utils) => async t => {
      utils.chdirWorkspaces();
    ...
    "`test monorepo --file=sub-ruby-app/Gemfile`": (
      params,
      utils
    ) => async t => {
      utils.chdirWorkspaces();
