...
export const DockerTests: AcceptanceTests = {
  ...
  tests: {
    ...
    "`test foo:latest --docker --platform=linux/amd64`": params => async t => {
      const spyPlugin = stubDockerPluginResponse(
        params.ecoSystemPlugins,
        {
          scanResults: [
    ...
    "`test foo:latest --docker --file=Dockerfile remediation advice`": params => async t => {
      stubDockerPluginResponse(
        params.ecoSystemPlugins,
        {
          scanResults: [
      ...
      const vulns = require(getFixturePath(
        "docker/find-result-remediation.json"
      ));
      params.server.setNextResponse(vulns);
    ...
    "`test foo:latest --docker with binaries vulnerabilities`": params => async t => {
      stubDockerPluginResponse(
        params.ecoSystemPlugins,
        {
          scanResults: [
      ...
      const vulns = require(getFixturePath("docker/find-result-binaries.json"));
      params.server.setNextResponse(vulns);
    ...
    "`test foo:latest --docker with dockerfile instructions`": params => async t => {
      stubDockerPluginResponse(
        params.ecoSystemPlugins,
        {
          scanResults: [
    ...
    "`test foo:latest --docker with auto detected instructions`": params => async t => {
      stubDockerPluginResponse(
        params.ecoSystemPlugins,
        {
          scanResults: [
