...
test('sln.updateArgs for existing sln with regular paths', (t) => {
  const args = {
    options: {
      file: 'test/acceptance/workspaces/sln-example-app/mySolution.sln',
      _: [],
    },
  };
...
test('sln.updateArgs for existing sln with relative paths', (t) => {
  const args = {
    options: {
      file: 'test/acceptance/workspaces/slnSolution.sln',
      _: [],
    },
  };
...
test('sln.updateArgs for sln with no relevant projects', (t) => {
  const args = {
    options: {
      file: 'test/acceptance/workspaces/emptySolution.sln',
      _: [],
    },
  };
