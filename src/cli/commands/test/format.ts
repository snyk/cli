...
export async function formatTestOutput(
  ...args: MethodArgs
  ...
  for (const path of paths) {
    ...
    res = Array.isArray(parsedData) ? parsedData : [parsedData];
    // try {
