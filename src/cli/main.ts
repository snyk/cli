...
export const HANDLED_ERROR = 'handled_error_magic_value';
...
function checkRuntime() {
  if (!runtime.isSupported(process.versions.node)) {
    console.error(
      `${process.versions.node} is an unsupported Node.js ` +
        `runtime! Supported runtime range is '${runtime.supportedRange}'`,
    );
    console.error('Please upgrade your Node.js runtime version and try again.');
    throw HANDLED_ERROR;
  }
}
...
export async function main() {
  ...
  if (runtime.isUsingNode6(process.versions.node)) {
    alerts.registerAlerts([
      {
        msg: `== WARNING ==========================================================
 Node.js v6 has reached end-of-life in April 2019.
 Snyk CLI will stop supporting Node 6 after January 2020.
 Please upgrade your Node.js (v10+ recommended) to continue scanning
 and protecting your projects from security vulnerabilities.

 More information: https://nodejs.org/en/about/releases/
=====================================================================
`,
