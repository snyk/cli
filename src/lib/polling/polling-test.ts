...
export async function getIssues(
  ...
  const payload = {
    method: 'POST',
    url: `${config.API_HIDDEN_URL}/orgs/${orgId}/unmanaged_ecosystem/issues?version=2023-08-31~ga`,
...
export async function getDepGraph(
  ...
  const payload = {
    method: 'GET',
    url: `${config.API_HIDDEN_URL}/orgs/${orgId}/unmanaged_ecosystem/depgraphs/${id}?version=2023-08-31~ga`,
  };
...
export async function createDepGraph(
  ...
  const payload = {
    method: 'POST',
    url: `${config.API_HIDDEN_URL}/orgs/${orgId}/unmanaged_ecosystem/depgraphs?version=2023-08-31~ga`,
    body: hashes,
  };
