 ...
 * @param {(string | undefined)} environmentDefinedApiUrl if there is an URL defined in the SNYK_API envvar
 ...
 * @param {string} environmentDefinedRestApiUrl
 * @param {string} environmentDefinedRestV3Url
 * @returns {string}
 */
export function getRestApiUrl(
  baseApiUrl: string,
  environmentDefinedRestApiUrl?: string,
  environmentDefinedRestV3Url?: string,
): string {
  ...
  if (environmentDefinedRestV3Url) {
    return validateUrlOrReturnDefault(
      environmentDefinedRestV3Url,
      "'SNYK_API_V3_URL' environment variable",
      defaultRestApiUrl,
    );
  }

  if (environmentDefinedRestApiUrl) {
    return validateUrlOrReturnDefault(
      environmentDefinedRestApiUrl,
