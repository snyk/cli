...
require (
	...
	github.com/snyk/cli-extension-os-flows v0.0.0-20260914121638-e23eca98f5aa
	...
	github.com/snyk/go-application-framework v0.25.1-0.20260915205521-1f1f3abeb57a
