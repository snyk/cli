...
require (
	...
	github.com/snyk/cli-extension-ai-redteam v0.0.0-20260312231149-363ad6a0a8e3
	...
	github.com/snyk/go-application-framework v0.0.0-20260312140622-7cf658e1f357
