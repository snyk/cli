...
// Exit code constants for the Snyk CLI.
// Please refer to the documentation in cmd/cliv2/behavior/maperrortoexitcode.go for guidance on exit code usage.
...
const SNYK_TEMP_PATH = "SNYK_TMP_PATH"
