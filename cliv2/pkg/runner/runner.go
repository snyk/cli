...
// additionalExts is set by Run before calling MainWithErrorCode.
var additionalExts []workflow.ExtensionInit
...
func Run(opts ...Option) int {
	...
	additionalExts = cfg.additionalExtensions
	return MainWithErrorCode()
}
