...
require (
	...
	github.com/snyk/remy-cli-extension v1.20.0
)
...
require (
	...
	github.com/snyk/cli-extension-os-flows v0.0.0-20260623133938-ef35fcbbd618 // indirect
	...
	github.com/snyk/go-application-framework v0.6.0 // indirect
