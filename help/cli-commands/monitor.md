...
Example: `$ snyk monitor --all-projects --exclude-paths=packages/api/package.json`

This will exclude only `packages/api/package.json` without affecting other `package.json` files in the project.

Example: `$ snyk monitor --all-projects --exclude-paths=packages/api/package.json,packages/web/package.json`
